function sendAddToCartRequest(service, url, data, onSuccess = () => {}, onFailure = () => {}) {
    ...
    .done(result => {
            console.log(result);
            const alert = $('#alert-top');
            const isOpen = alert.hasClass('open');
            ...
            if(!isOpen) {
                const right = $('.container').offset().left;
